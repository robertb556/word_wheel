...
var Keyboard = function(){
	...
	me.onkeydown = function(e){
		if(me.keys[e.keyCode] !== true){
			me.keys[e.keyCode] = true;
			//console.log("key["+e.keyCode+"]");
			me.callListeners(e.keyCode);
		}
	};
	
	me.isDown = function(keyCode){
		if(me.keys[keyCode] === true) return true;
		else return false;
	};
	...
	me.callListeners = function(keycode){
